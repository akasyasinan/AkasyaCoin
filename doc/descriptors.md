# Support for Output Descriptors in Akasyacoin Core

Since Akasyacoin Core v0.17, there is support for Output Descriptors. This is a
...
on Akasyacoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Akasyacoin Core wallets, a convenience function `combo` is
