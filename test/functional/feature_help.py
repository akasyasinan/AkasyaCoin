...
"""Verify that starting akasyacoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start akasyacoin with -h for help text")
        ...
        self.log.info("Start akasyacoin with -version for version information")
        ...
        self.log.info("Start akasyacoind with -fakearg to make sure it does not start")
