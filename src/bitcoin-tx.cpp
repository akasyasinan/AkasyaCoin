...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " akasyacoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  akasyacoin-tx [options] <hex-tx> [commands]  Update hex-encoded akasyacoin transaction\n" +
            "or:     akasyacoin-tx [options] -create [commands]   Create hex-encoded akasyacoin transaction\n" +
            "\n";
