...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.akasyacoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.akasyacointools.com");
        vSeeds.emplace_back("dnsseed.akasyacoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.akasyacointools.com");
        vSeeds.emplace_back("seed-b.akasyacoin.loshan.co.uk");
